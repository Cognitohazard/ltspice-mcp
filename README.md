...
| `agentic` | 35 | LLM agents with native file access (Read/Edit/Write) |
...
| `plot_waveform` | Interactive HTML chart (transient / DC / Bode dual-panel / noise / `.step` overlay) written next to the circuit and opened in your browser; for seeing shape, not measuring |
