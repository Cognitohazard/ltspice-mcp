...
async def run():
    ...
    async with stdio_client(params) as (rs, ws):
        async with ClientSession(rs, ws) as session:
            ...
            # ----------------------------------------------------------
            step(1, "Check server status")
            r = await session.call_tool("ltspice_get_server_status", {},
            ...
            print(f"  Config: working_dir={config['working_dir']}, "
