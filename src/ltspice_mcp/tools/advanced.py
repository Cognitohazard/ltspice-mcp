...
@registry.tool(
    ...
    description=(
        ...
        "Temperature is NOT available as a dimension here: a `temp` parameter is "
        "written as a .param and does not set simulation temperature. Put `.step "
        "temp <list>` in the deck instead, where the simulator applies it. "
